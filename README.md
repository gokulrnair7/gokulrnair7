...
### [Budget vs Actual Variance Analysis](https://github.com/gokulrnair7/sankalp-industries-budget-vs-actual-variance-analysis)
...
### [Revenue and Profitability Analysis](https://github.com/gokulrnair7/vastra-junction-revenue-profitability)
...
### [Integrated 3-Statement Financial Model](https://github.com/gokulrnair7/integrated-3-statement-financial-model-mphasis)
Excel
...
**SQL Server** for cleaning and analysis: CTEs, window functions, joins across a star schema.
**Power BI** for dashboards, including the DAX behind them.
**Excel** for financial models, variance bridges and scenario work.
**Python** with pandas and numpy, mainly for data generation and preparation.
...
LinkedIn: [gokul-r-nair](https://www.linkedin.com/in/gokulrnair7/)
